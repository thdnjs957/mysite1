		...
		<div id="header">
			...
			<ul>
				<c:choose>
					...
					<c:otherwise>
						<li><a href="${pageContext.servletContext.contextPath }/user?a=updateform&no=${authUser.no}">회원정보수정</a><li>
						...
						<li><a href="${pageContext.servletContext.contextPath }/user?a=myInfo&no=${authUser.no}">${authUser.name}</a>님 안녕하세요 ^^</li>
					</c:otherwise>
				</c:choose>
			</ul>
		</div>